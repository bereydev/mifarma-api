...
Revision ID: 0144330bdb4e
Revises: b8fffe059039
Create Date: 2021-06-15 19:47:03.495345
...
revision = '0144330bdb4e'
down_revision = 'b8fffe059039'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_products_name_unaccented'), 'products', ['name_unaccented'], unique=False)
...
def downgrade():
    ...
    op.drop_table('roles')
    op.drop_index(op.f('ix_products_name_unaccented'), table_name='products')
